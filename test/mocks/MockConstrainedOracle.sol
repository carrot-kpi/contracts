...
contract MockConstrainedOracle is ConstrainedOracle {
    function initialize(InitializeOracleParams memory _params) external payable override initializer {
        ...
        __ConstrainedOracle_init(
            _params.kpiToken, _params.templateId, _params.templateVersion, _constraint, _value0, _value1
        );
    }
